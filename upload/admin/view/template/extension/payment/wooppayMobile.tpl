    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-wooppayMobile" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-wooppayMobile"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_merchant" value="<?php echo $wooppayMobile_merchant; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="wooppayMobile_password" value="<?php echo $wooppayMobile_password; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_url" value="<?php echo $wooppayMobile_url; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_prefix" value="<?php echo $wooppayMobile_prefix; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_service" value="<?php echo $wooppayMobile_service; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_result_url" readonly="readonly"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_success_url" readonly="readonly"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="wooppayMobile_order_success_status_id" id="input-wooppay_order_success_status_id"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == $wooppayMobile_order_success_status_id) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="wooppayMobile_order_processing_status_id"
                                    id="input-wooppay_order_processing_status_id"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == $wooppayMobile_order_processing_status_id) { ?>
                                <option value="<?php echo $order_status['order_status_id']; ?>"
                                        selected="selected"><?php echo $order_status['name']; ?></option>
                                <?php } else { ?>
                                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="wooppayMobile_status" id="input-wooppay_status" class="form-control">
                                <?php if ($wooppayMobile_status) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wooppayMobile_sort_order" value="<?php echo $wooppayMobile_sort_order; ?>"
